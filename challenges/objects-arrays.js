...
/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that 
...
unisWithUni = (letters) => {
  return universities.filter(uniName => uniName.indexOf(letters) > -1);
}
...
the .reduce() method. Remember the reduce method takes two arguments: a callback (which itself takes two args), and an initial value 
for the count.
*/
